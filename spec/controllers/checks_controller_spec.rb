  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved check as @check" do
        ...
        post :create, {:check => { "name" => "invalid value" }}, valid_session
        assigns(:check).should be_a_new(Check)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested check" do
        ...
        Check.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => check.to_param, :check => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the check as @check" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Check.any_instance.stub(:save).and_return(false)
        put :update, {:id => check.to_param, :check => { "name" => "invalid value" }}, valid_session
        assigns(:check).should eq(check)
      end
